    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'originators',
            data: { title: 'Loan Originators', breadcrumb: 'Originators', routeParamBreadcrumb: false },
            resolve: {
